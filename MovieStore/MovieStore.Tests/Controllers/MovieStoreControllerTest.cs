namespace MovieStore.Tests.Controllers
{
	...
	public class MovieStoreControllerTest
	{
		...
		public void MovieStore_IndexRedirect_BadRequest()
		{
			...
			// Assert
			Assert.AreEqual(HttpStatusCode.BadRequest, actual: (HttpStatusCode)result.StatusCode);
		}
		...
		public void MovieStore_Details_MovieIsNull()
		{
			...
			// Assert
			Assert.AreEqual(HttpStatusCode.NotFound, actual: (HttpStatusCode)result.StatusCode);
		}
	}
}
